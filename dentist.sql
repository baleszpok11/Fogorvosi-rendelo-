...
INSERT INTO `Appointment` (`appID`, `schedule`, `doctorID`, `patientID`, `procedureID`, `token`) VALUES
...
(11, 20, 6, '2021-10-20', 'Fogkő eltávolítás', 'A páciens jól viselte az eljárást.', 40000.00, 5, 1),
...
--
ALTER TABLE `Appointment`
  MODIFY `appID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

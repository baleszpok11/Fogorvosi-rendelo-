...
INSERT INTO `Appointment` (`appID`, `schedule`, `doctorID`, `patientID`, `procedureID`)
VALUES (33, '2024-06-25 08:00:00', 1, 12, 1),
...
INSERT INTO `Patient` (`patientID`, `userName`, `firstName`, `lastName`, `password`, `phoneNumber`, `email`, `forgot`,
                       `remember`, `auth`)
VALUES (1, '', 'Balint', 'Balog', '$2y$10$Va8zpU.BTa1cq6kk4/dcye775PXglsuVWzITH6h6gZJp5OShZKWBy', '5', 'asd@gmail.com',
        NULL, NULL, ''),
       (2, '', 'Seruga', 'Seril', '$2y$10$QXiATrCGBOOvW1GeJAs/zu0evsFOie/KOln26TaeM4sAt1UBdurny', '555666555',
        'example@gmail.com', NULL, NULL, ''),
       (3, '', 'balint', 'balog', '$2y$10$7EvpDlpxDpAT0/3yBnGX1el5/L3x3T1NgHhpSlqtI5vGSHDg3aNxy', '03', 'b@gmail.com',
        NULL, NULL, ''),
       (4, '', 'test', 'test', '$2y$10$i8ngZ2olDku8QpMfgRWDQOmznakaRYYaMsVz5kq8Farz07jPG7.DK', 'test', 'test@test.test',
        NULL, NULL, ''),
       (5, '', 'test1', 'test1', '$2y$10$bQHg7v366w4SDyLLKV4A9e3/dxIbn69XvQPt58vJwhdxIg7PCJfwS', 'test1',
        'test1@test1.test1', NULL, NULL, ''),
       (6, '', 'Test2', 'Test2', '$2y$10$eenN6LtkAWrudkcnMWpxXeahIADYz9s/QwQwSQnH.nb3ho15jV0EC', 'Test2',
        'test2@test2.test2', NULL, NULL, ''),
       (7, '', 'Test3', 'Test3', '$2y$10$kQq.4wqzEmHpOEoBjGqOWezyyl6g4h48JP28SSnMcwwSXw/lWKRXu', 'Test3',
        'test3@test3.com', NULL, NULL, ''),
       (8, '', 'Test4', 'Test4', '$2y$10$rNCMZTurBnDEVSixYLRec.CvR6lVwz78kfbkZLSCEY0O9dwEgZz0S', 'Test4',
        'test4@test4.com', NULL, NULL, ''),
       (9, '', 'Test5', 'Test5', '$2y$10$8of2IKMn44WQCjDwIozcseB1Q4yWl85F3vT2isD5kYDNblRy1kQ0q', 'Test5',
        'test5@test5.test5', NULL, NULL, ''),
       (10, '', 'Test6', 'Test6', '$2y$10$OMpOmWOLcObEsdVBMMy2LeWuxLYKngHIzqku4wx4PI6k7kOnWqjey', 'Test6',
        'Test6@Test6.Test6', NULL, NULL, ''),
       (11, '', 'Test8', 'Test8', '$2y$10$HO/m/w.KZ950dNdGy2eEcuvV.c1fZ4fXYT50hIxll7H8G79bTB7y.', '0652759823',
        'Test8@Test8.com', NULL, NULL, ''),
       (12, 'Test9', 'Test9', 'Test9', '$2y$10$8vnU4MKuH1kFdOaqjTv3fuFWG5a9x12fpt3/K3ohEEvVbLAVUwm2.', 'Test9',
        'Test9@Test9.Test9', NULL, '5c516836c31c6b6f2d6fb1adaa2565560801505cafb8646f8c6698c3fd7a0910', NULL);

            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php else: ?>
                    ...
                    if (isset($_SESSION['doctorID'])) {
                        ...
                        echo '<li class="active"><a href="admin.php">Admin oldal</a></li>';
                    }
                    ?>
                    <li class="dropdown">
...
<div>
    <h2>Szolgáltatás bevitele és módosítás </h2>
    <form action="functions/manage_services.php" method="post">
        ...
        <label for="procedureID">Szolgáltatás ID (frissítéshez):</label>
